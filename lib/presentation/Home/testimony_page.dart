...
class Testimony extends StatefulWidget {
  const Testimony({super.key, required this.context});
  ...
  void initState() {
    ...
    listContentConfig.add(
      ContentConfig(
        title: 'WHAT THEY SAY',
        styleTitle:
            (widget.context.isSmallScreen ? UITextStyle.h3 : UITextStyle.h3PC)
                .copyWith(color: WangHannColor.white),
        textAlignTitle: TextAlign.left,
        marginTitle: EdgeInsets.zero,
        widgetDescription:
            (widget.context.isSmallScreen ? testimony : pcTestimony)(
