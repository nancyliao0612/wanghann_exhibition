        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  '台灣腦中風學會與台灣肌肉骨骼神經超音波醫學會攜手共著《Post-Stroke Spasticity: Ultrasound-Guided Botulinum Toxin Injection》針對臨床常見的８種痙攣型態，給予治療評估、肌肉定位及肉毒桿菌素注射的全方位建議。手冊內容包含：8 種常見痙攣治療建議，超音波、EMG導引治療準備建議、教學精華影片！',
